...
const MakeRentalModal = props => {
    ...
    try {
        // TODO: async needs to wait for result
        var rentTuple = ClerkTransactions.rentVehicleAsync(props.location.state.reservationObj.confNo,
            CITY,
            LOCATION,
            props.location.state.reservationObj.fromdate,
            props.location.state.reservationObj.fromtime,
            props.location.state.reservationObj.todate,
            props.location.state.reservationObj.totime,
            VEHICLETYPE,
            CELLPHONE,
            dlicense,
            cardName,
        ...
        // TODO do something with rentTuple: ie. print it for customer
    } catch {
